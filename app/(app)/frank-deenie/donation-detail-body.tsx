...
export interface DonationDetailBodyProps {
  row: FrankDeenieDonationRow;
  isAdmin: boolean;
  readOnly?: boolean;
  deletingRowId: string | null;
  initialMode: DetailMode;
  /** Reset internal edit state when this changes (e.g. drawer reopened or a new row tapped). */
  ...
  /** If true, render the close button in the header. Inline expansion can hide it (row card owns collapse). */
  showCloseButton?: boolean;
}

export const DonationDetailBody = memo(function DonationDetailBody({
  row,
  isAdmin,
  readOnly,
  deletingRowId,
  ...
  const showFooter =
    !readOnly &&
    (row.editable || isAdmin || (row.returnRole === null && row.status === "Gave") || row.returnRole !== null);
